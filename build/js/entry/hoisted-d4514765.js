...
if (window.innerWidth <= 992 && burger) {
...
function validation(formSubmit, idForm, url) {
...
if (modalForm instanceof HTMLFormElement) {
  validation(
    modalForm,
    "success",
    "/wp-content/themes/sa-kraft/mail/mail_consultation.php",
  );
}
...
if (formOrder instanceof HTMLFormElement) {
  validation(
    formOrder,
    "success",
    "/wp-content/themes/sa-kraft/mail/mail_feedback.php",
  );
}
